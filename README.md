...
TriggerEvent('invhud:lockInv', true) TO SET LOCK THEM OUT OF OPENING THEIR INVENTORY, USE THE EVENT TriggerEvent('invhud:lockInv', false) TO UNLOCK THEIR ABILITY
