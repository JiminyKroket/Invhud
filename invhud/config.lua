Config = {}
Config.Locale = 'en'
Config.JustGoToFucking1Point2 = false -- SET TRUE IF YOU ARE RUNNING THE ESX1.1.5, LIMIT WITH WEIGHT
-- THE ONE THAT ISN'T ON ESX-ORG GITHUB ANYWHERE AND HAS TO SPECIALLY BE DOWNLOADED FROM THE DISCORD SERVER BECAUSE ITS NOT MEANT TO BE USED
...
Config.Use = { -- SET ALL USE INFORMATION HERE:LICENSES(SHOULD THE SCRIPT USE THE LICENSE SYSTEM FOR ANY SHOPS), SOCIETIES(SHOULD THE SCRIPT USE THE SOCIETY SYSTEM FOR ANY SHOPS),
	...
	-- NONNPCVEHICLES(SHOULD THE SCRIPT ALLOW CREATING AND USING INVENTORIES FOR VEHICLES THAT ARE NOT OWNED BY ANY PLAYER), MONEYIN(SHOULD THE SCRIPT ALLOW MONEY IN THE LISTED INVENTORIES?)
	Licenses = false,
	Societies = false,
	ForceSearch = true,
	AdminSearch = true,
