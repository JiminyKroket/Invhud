Config = {}
Config.Locale = 'en'
Config.JustGoToFucking1Point2 = false -- SET TRUE IF YOU ARE RUNNING THE ESX1.1.5
-- THE ONE THAT ISN'T ON GITHUB ANYWHERE AND HAS TO SPECIALLY BE DOWNLOADED FROM THE DISCORD SERVER BECAUSE ITS NOT MEANT TO BE USED
